        ...
        <div class="container">
            <div class="row gy-4 d-flex justify-content-between">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <form action="/sesi/register" method="POST" class="form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
                        @csrf
                        <input placeholder="Nama" type="text" name="name" value="{{ Session::get('username') }}" class="form-control">
                        <input placeholder="Email" type="email" value="{{ Session::get('email') }}" name="email" class="form-control">
